import { Project, Education, SkillGroup, Experience, ContentWork } from './types';
...
export const EXPERIENCES: Experience[] = [
  {
    ...
    period: '3 Mois',
    description: 'Contribution à l’élaboration du cahier des charges, création des maquettes complètes du site, de l’application web et mobile d’ECOTADJI.',
  },
  {
    id: '2',
    ...
    period: '3 Mois',
    description: 'Création de contenus visuels et gestion des réseaux sociaux pour renforcer l’image et la visibilité digitale de l’entreprise et de ses clients.',
  },
];
...
export const PROJECTS: Project[] = [
  {
    ...
    category: 'Mobile App',
    description: 'Application complète de réservation d’hébergements intégrant un système client, hôte et dashboard.',
    problem: 'Difficulté de centraliser les offres d\'hébergement et de gérer les réservations en temps réel.',
    solution: 'Utilisation de Flutter pour le front-end et Firebase pour le back-end et la base de données.',
  ...
  },
  {
    ...
    description: 'Plateforme pour la réservation, le suivi des événements et la gestion des utilisateurs.',
    problem: 'Manque d\'outils intégrés pour la gestion fluide d\'événements à Orange Digital Kalanso.',
    solution: 'Architecture Angular (front-end), Spring Boot (back-end) et MySQL (base de données).',
  ...
  },
  {
    ...
    description: 'Création de maquettes interactives et de prototypes fonctionnels pour des plateformes complexes.',
    problem: 'Nécessité d\'interfaces intuitives adaptées aux besoins des utilisateurs finaux.',
    solution: 'Conception sous Figma avec focus sur l\'ergonomie et le parcours utilisateur.',
...
export const SKILLS: SkillGroup[] = [
  {
    ...
    skills: [
      ...
      { name: 'Java/JEE', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg' },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'CapCut', icon: 'https://www.vectorlogo.zone/logos/capcut/capcut-icon.svg' },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'IA Tools', icon: 'https://www.vectorlogo.zone/logos/google_cloud/google_cloud-icon.svg' },
      { name: 'Agile', icon: 'https://www.vectorlogo.zone/logos/atlassian_jira/atlassian_jira-icon.svg' },
